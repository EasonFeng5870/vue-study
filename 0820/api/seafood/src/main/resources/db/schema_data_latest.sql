...
-- Records of orders
-- ----------------------------
INSERT INTO `orders` VALUES ('1', '1', '1', '1', '1', '1', '1', null, '{\'method\': \'CR\', \'account\': \'1234567890123456\', \'holdername\': \'Pooky Doo\', \'expirydate\': \'2911\', \'billingzipcode\': \'98004\' }', '2022-09-10 23:35:10', '2022-09-10 23:35:10');
...
CREATE TABLE `order_line_items` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='订单与商品关系表';

-- ----------------------------
-- Records of order_line_items
-- ----------------------------
INSERT INTO `order_line_items` VALUES ('1', '1', '10101', '2022-09-11 08:40:52', '2022-09-11 08:40:52', '7', '64.3', 'SF1370217729273', '顺丰速递', '0');
...
-- Records of products
-- ----------------------------
INSERT INTO `products` VALUES ('10101', '10102', '10102', '10102', '10102', '10102', '10102', '10102', '10102', '10102', '10102', '10102', '2010-10-02 00:00:00', '2010-10-02 00:00:00');
INSERT INTO `products` VALUES ('10102', '1', '3', '', null, null, null, null, null, '0', null, '1', '2022-09-01 23:15:19', '2022-09-01 23:15:19');
